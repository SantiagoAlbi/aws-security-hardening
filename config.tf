# S3 Bucket para AWS Config logs
...
# Attach AWS managed policy para Config
...
# Rule 1: S3 buckets deben tener encriptación
...
# Rule 2: Root account no debe tener access keys
...
# Rule 4: EBS volumes deben estar encriptados
...
# Rule 5: Security Groups no deben permitir 0.0.0.0/0 en puertos críticos
